...
def intent_recognize(args, text, tokenizer, model, label_tab):
...
def main(args):
    ...
    while(True):
        text = input("请输入文本：")
        intent = intent_recognize(args, text, tokenizer, model, label_tab)
        print("主题：", intent)


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--info_path', type=str, default="./preprocess/intent_info.pt")
    parser.add_argument('--model_path', type=str, default='./model/intent.pth')
